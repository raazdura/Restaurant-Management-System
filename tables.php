						...
						<div class="below-toggle-content">
							<div class="col-md-12">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<a href="add_table.php"><button class="btn btn-primary add-group shadow-none" data-toggle="modal" data-target="#AddModal">Add Table</button></a>
									</div>	
