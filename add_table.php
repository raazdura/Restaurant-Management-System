						...
						<div class="below-toggle-content">
							<div class="col-md-12">
								...
								<?php 
		                      	...
		                      	?></h5> -->
								<div class="row">
									<form method="POST" action="backend/add_table_back.php" class="p-3">
										
										<div class="form-group">
									    	<label for="table-name" style="font-weight: 600;">Table Name</label>
									    	<input type="text" name="table-name" class="form-control shadow-none" id="table-name" placeholder="Enter Table Name">
									  	</div>
									  	<div class="form-group">
									    	<label for="capacity" style="font-weight: 600;">Capacity</label>
									    	<input type="text" name="capacity" class="form-control shadow-none" id="capacity" placeholder="Enter Capacity of The table">
									  	</div>
