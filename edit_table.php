...
<body>
	<div class="wrapper">
        ...
        include "config.php";
        $qry = "SELECT * FROM tables WHERE id = $id";
						...
						<div class="below-toggle-content">
							<div class="col-md-12">
								...
								<?php 
		                      	...
		                      	?></h5> -->
								<div class="row">
									<form method="POST" action="backend/edit-table.php" class="p-3">
										
                                        <div class="form-group">
									    	<label for="table-id" style="font-weight: 600;">Table ID</label>
									    	<input type="text" name="table-id" class="form-control shadow-none" id="table-id" placeholder="Enter Table Name" value="<?php echo $id ?>">
									  	</div>
                                        <div class="form-group">
									    	<label for="table-name" style="font-weight: 600;">Table Name</label>
									    	<input type="text" name="table-name" class="form-control shadow-none" id="table-name" placeholder="Enter Table Name" value="<?php echo $row['table_name']; ?>">
									  	</div>
									  	<div class="form-group">
									    	<label for="capacity" style="font-weight: 600;">Capacity</label>
									    	<input type="text" name="capacity" class="form-control shadow-none" id="capacity" placeholder="Enter Capacity of The table" value="<?php echo $row['capacity']; ?>">
									  	</div>
