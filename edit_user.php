						...
						<div class="below-toggle-content">
							<div class="col-md-12">
								<div class="top-part mb-3">
									<h2 class="d-inline">Edit</h2>
									<p class="d-inline ml-2">User</p>
								...
								<div class="row">
									<!-- <form action="backend/edit-user.php" method="POST" class="p-3" enctype="multipart/form-data"> -->
                  <form action="backend/edit-user.php" method="POST" class="p-3" enctype="multipart/form-data">
                  <div class="form-group">
									    	<label for="userid" style="font-weight: 600;">User ID</label>
									    	<input type="text" name="userid" class="form-control shadow-none" id="userid" placeholder="<?php echo $id ?>" value="<?php echo $id ?>">
									  	</div>          
										<div class="form-group">
									    	<label for="username" style="font-weight: 600;">Username</label>
									    	<input type="text" name="username" class="form-control shadow-none" id="username" placeholder="<?php echo $row['username'] ?>" value="<?php echo $row['username'] ?>">
									  	</div>
                      <div class="form-group">
									    	<label for="firstname" style="font-weight: 600;">Firstname</label>
									    	<input type="text" name="firstname" class="form-control shadow-none" id="firstname" placeholder="<?php echo $row['firstname'] ?>" value="<?php echo $row['firstname'] ?>">
									  	</div>
                      <div class="form-group">
									    	<label for="lastname" style="font-weight: 600;">Lastname</label>
									    	<input type="text" name="lastname" class="form-control shadow-none" id="lastname" placeholder="<?php echo $row['lastname'] ?>" value="<?php echo $row['lastname'] ?>">
									  	</div>
                      <div class="form-group">
									    	<label for="phone" style="font-weight: 600;">Phone</label>
									    	<input type="text" name="phone" class="form-control shadow-none" id="phone" placeholder="<?php echo $row['phone'] ?>" value="<?php echo $row['phone'] ?>">
									  	</div>
                      <div class="form-group">
									    	<label for="email" style="font-weight: 600;">Email</label>
									    	<input type="text" name="email" class="form-control shadow-none" id="email" placeholder="<?php echo $row['email'] ?>" value="<?php echo $row['email'] ?>">
									  	</div>
                      <div class="form-group">
