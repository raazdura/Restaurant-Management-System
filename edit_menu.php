						...
						<div class="below-toggle-content">
							<div class="col-md-12">
								...
								<div class="row">
									...
									<form method="POST" action="backend/edit-menu.php" class="p-3" enctype="multipart/form-data">
                                    
                                        <div class="form-group">
									    	<label for="food-id" style="font-weight: 600;">Food ID</label>
									    	<input type="text" name="food-id" class="form-control shadow-none" id="food-id" value="<?php echo $id ?>">
									  	</div>
                                        <div class="form-group">
									    	<label for="food-name" style="font-weight: 600;">Food Name</label>
									    	<input type="text" name="food-name" class="form-control shadow-none" id="food-name" placeholder="Enter Food Name" value="<?php echo $row['f_name'] ?>">
									  	</div>
									  	<div class="form-group">
									    	<label for="price" style="font-weight: 600;">Price</label> 
									    	<input type="text" name="price" class="form-control shadow-none" id="price" placeholder="Enter Capacity of The table" value="<?php echo $row['price'] ?>">
									  	</div>
                                        <div class="form-group">
                                            <div class="mb-3">
